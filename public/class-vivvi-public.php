...
class ViVVi_Public {
	...
	public function enqueue_public_resources() {
         ...
         * class.
         */
		wp_enqueue_style( $this->id, ViVVi_URL . 'public/css/vivvi-public.css', array(), $this->version, 'all' );
        wp_enqueue_script( $this->id, ViVVi_URL . 'public/js/vivvi-public.js', array( 'jquery' ), $this->version, false );
