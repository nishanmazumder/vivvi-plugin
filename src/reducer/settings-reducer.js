...
const SettingsReducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case 'UPDATE_SETTINGS':
            ...
            let canSave = false,
                notice = __('Saved Successfully.', 'vivvi_text_domain'),
                hasError = false;
            if (typeof action.payload.fetchedSettings.vivvi_options_update_settings_errors !== 'undefined') {
                canSave = true;
                notice = __('An error occurred.', 'vivvi_text_domain');
                hasError = true;
            }
